					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="username" style="width: 500px" id="username" lay-verify="required" placeholder="账户" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuName" style="width: 500px" id="yonghuName" lay-verify="required" placeholder="姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="idNumber" style="width: 500px" id="idNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="phone" style="width: 500px" id="phone"  lay-verify="required|phone"   placeholder="手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
