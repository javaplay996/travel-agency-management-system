                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiudianName" id="jiudianName" placeholder="酒店名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jiudian/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.jiudianPhoto?item.jiudianPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jiudian/detail.jsp?id='+item.id)"><span>{{item.jiudianName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.jiudianNewMoney"><span style="color: red;">{{item.jiudianNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 newContent 字段去除无用字符 如果字段长度大于60  就截取到60
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#jiudianName').val() != null && jquery('#jiudianName').val() != "" && jquery('#jiudianName').val() != "null" ) {
                param['jiudianName'] = jquery('#jiudianName').val();
            }
                                    // 获取列表数据
            http.request('jiudian/list', 'get', param, function(res) {
