...
<div id="app">
    ...
    <div class="line-container">
        <p class="line" style="background: #EEEEEE;"> 我的景点订单  </p>
    </div>
    <!-- 标题 -->
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <td style="width: 50px;">{{item.jingdianId}}</td>
                        <td style="width: 60px;">{{item.jingdianName}}</td>
                        <td style="width: 80px;">{{item.jingdianValue}}</td>
                        <td style="width: 80px;">{{item.jingdianDengjiValue}}</td>
                        <td style="width: 250px;">
                            <img :src="item.jingdianPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                        </td>
                        <td style="width: 100px;color: red">{{item.jingdianNewMoney}}</td>
                        <td style="width: 150px;">{{item.jingdianOrderTime}}</td>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                    // 获取列表数据
            http.request('jingdianOrder/list', 'get', param, function(res) {
