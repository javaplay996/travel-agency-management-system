            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">酒店订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>预定开始时间</label>
                                        <input id="jiudianOrderStartTime" name="jiudianOrderStartTime" class="form-control"
                                               v-model="ruleForm.jiudianOrderStartTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>预定结束时间</label>
                                        <input id="jiudianOrderEndTime" name="jiudianOrderEndTime" class="form-control"
                                               v-model="ruleForm.jiudianOrderEndTime" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiudianOrder/info/" + id,
        ...
        if (ruleForm.jiudianContent != null && ruleForm.jiudianContent != 'null' && ruleForm.jiudianContent != '') {
            var jiudianContentUeditor = UE.getEditor('jiudianContentEditor');
                jiudianContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jiudianContent;
