            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">景点订单 管理</li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">景点订单 信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                   <div class="form-group col-md-6">
                                       <label>游玩时间</label>
                                       <input id="jingdianOrderTime-input" name="jingdianOrderTime" type="text" class="form-control layui-input">
                                   </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("jingdianOrder/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addjingdianOrder');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                jingdianId: "required",
                yonghuId: "required",
                jingdianOrderTime: "required",
                insertTime: "required",
            },
            messages: {
                jingdianId: "景点id不能为空",
                yonghuId: "用户id不能为空",
                jingdianOrderTime: "游玩时间不能为空",
    ...
    // 获取当前详情
    function getDetails() {
        var addjingdianOrder = window.sessionStorage.getItem("addjingdianOrder");
        if (addjingdianOrder != null && addjingdianOrder != "" && addjingdianOrder != "null") {
            window.sessionStorage.removeItem('addjingdianOrder');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("jingdianOrder/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jingdianOrderTime-input").val(ruleForm.jingdianOrderTime);
